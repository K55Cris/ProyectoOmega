...
namespace UnityStandardAssets.SceneUtils
{
    public class ParticleSceneControls : MonoBehaviour
    {
        ...
        private ParticleSystem m_ParticleMultiplier;
                ...
                if (Physics.Raycast(ray, out hit))
                {
                    ...
                    if ((pos - m_LastPos).magnitude > s_Selected.minDist)
                    {
                        if (s_Selected.mode != Mode.Trail || m_Instance == null)
                        {
                            ...
                            {
                                //m_Instance.GetComponent<ParticleSystem>().multiplier = multiply;
                            }
        ...
        private void Select(int i)
        {
            ...
            m_ParticleMultiplier = s_Selected.transform.GetComponent<ParticleSystem>();
            multiply = 1;
            if (clearOnChange)
            {
